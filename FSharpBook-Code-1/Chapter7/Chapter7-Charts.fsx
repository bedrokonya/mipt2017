...
// Основано на коде James Hugard, доступном тут: http://stackoverflow.com/questions/3276357/how-do-i-plot-a-data-series-in-f 
...
// Function to fetch HTML from given URL
let http(url: string) = 
